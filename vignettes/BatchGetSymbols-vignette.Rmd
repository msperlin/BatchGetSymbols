...
- A cache system was implemented in version 2.0, meaning that the data is saved locally and only missings portion of the data are downloaded, if needed. 
- User can choose complete or no complete datasets
- Allows the choice for the wide format
